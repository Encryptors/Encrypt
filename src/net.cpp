...
bool GetMyExternalIP22(const CService& addrConnect, const char* pszGet, const char* pszKeyword, CNetAddr& ipRet)
{
    SOCKET hSocket;
...
std::mapCNetAddr, int64> CNode::setBanned;
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Encryptcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"encryptcointools.com", "encryptcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"encryptcointools.com", "testnet-seed.encryptcointools.com"},
    {"xurious.com", "testnet-seed.ecr.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Encryptcoin is probably already running."), addrBind.ToString().c_str());
        else
